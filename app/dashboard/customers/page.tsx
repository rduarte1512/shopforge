...
export default function CustomersPage() {
  const { currentUser, stores, orders, selectedStoreId } = useMockDB();
      ...
      <div className="bg-white rounded-[8px] shadow-[var(--shadow-card)] border border-[var(--color-border)] p-5 overflow-x-auto">
        <table className="w-full border-collapse min-w-[700px]">
          ...
          <tbody>
            ...
            {customers.length === 0 && (
              <tr>
                <td colSpan={6} className="py-12 text-center text-[13px] text-text-muted border-b border-[#F1F1F1] flex flex-col items-center">
