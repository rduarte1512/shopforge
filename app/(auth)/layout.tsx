...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-screen bg-white relative overflow-hidden flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      ...
      >
        <Link href="/" className="flex justify-center items-center gap-2 text-3xl font-black tracking-tighter text-slate-900 group">
      ...
      >
        <div className="bg-white py-10 px-6 shadow-2xl shadow-primary/5 sm:rounded-[2rem] sm:px-12 border border-gray-100 backdrop-blur-xl relative z-10">
          {children}
        </div>
      </motion.div>
    </div>
